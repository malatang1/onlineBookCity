...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="/T-GWAP/user/verifyemail" method="post">
			<div class="validate_email">
				<h2>
					感谢您注册思源线上书城！现在请按以下步骤完成您的注册!
				</h2>
				<div class="look_email">
					...
					<div class="mess reduce_h">
						...
						<span><s:property value="#session.user.email_verify_code"/>-<s:property value="#session.user.id"/></span>
					</div>
					<h4>
						第二步：输入验证码
					</h4>
					<div class="mess">
						...
						<span id="errorMsg" class="no_right">${verifyerror==null?"":verifyerror }</span>
					</div>
				</div>
			</div>
		</form>
